...
user_input="";
count=5;
while user_input != secret_word and count >0:
    user_input=input("Enter secret word");
    count-=1
    if count > 0 and user_input != secret_word:
        print("attempts remainning :"+str(count))
    if count ==0:
        print("ohhh you have lost your all attempts")
    if user_input == secret_word:
        print("you win !!!")
#-----------------------------------For loop in python-------------------------------------------------------
for char in "Accenture Bangalore":
    print(char)
cities=["newyork","paris","london","sydiny","tokoyo"];
for city in cities:
    print(city)
#  -----------range---------
